...
- ⚔️ **装备系统**：武器、护甲、头盔、下装、靴子、灵宝、法器、护符共8种装备
...
### 装备系统
- ✅ 8种装备槽位：武器、护甲、头盔、下装、靴子、灵宝、法器、护符
- ✅ 装备品质：白、蓝、紫、金、彩 5种品质
...
├── 📄 package.json            # 项目配置
├── 📄 .gitignore              # Git忽略配置
├── 📄 CONSTANTS_REFACTORING.md # 常量重构文档
├── 📄 SKILL_SYSTEM_DESIGN.md      # 技能系统设计文档
└── 📄 README.md               # 项目说明文档
```
...
**详细设计文档**：参见 [SKILL_SYSTEM_DESIGN.md](./SKILL_SYSTEM_DESIGN.md)
